...
SELECT * FROM Usr_ATE_Values_srs where ATEID = 17 order by Value_Set --<<<=============== This is the code to check the ATE Values
...
-- Set the figure in the individual Value column 
begin tran
update Usr_ATE_Values_srs set Value = 50.00 where id = 121

-- Set the other case type values to NULL - MT ELPL etc.
begin tran
update Usr_ATE_Values_srs set MT_Values = NULL,PL_Value = NULL,EL_Value = NULL where id in(118,119,120,121,122,123,124,125,126,127,128)


-- Set the non-required Fast Track values to NULL
begin tran
update Usr_ATE_Values_srs set Value = NULL where id in(122,123,124)
...
--============================== Code from Mike for checking the Values against a give ATE Provider===========================================
