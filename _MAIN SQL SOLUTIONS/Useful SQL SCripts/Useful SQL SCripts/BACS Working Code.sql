...
SELECT @x = ParamData 
	...
	WHERE EntityRef = 'BEA000000002180'
	AND MatterNo = 1
	AND ProcessID = 1
select @x
...
-- Client Ledger
select * from Ac_Client_Ledger_Transactions WHERE Client_Code = 'BEA000000002180' AND Matter_No = 1


-- Cheques Table
select * from Usr_Incoming_Cheque_Details  where Entityref = 'BEA000000002180' and MatterNo = 1
-- Client Table
select * from usr_cheques_in_client_tab_srs  where Entityref = 'BEA000000002180' and MatterNo = 1
-- Office Table
select * from usr_cheques_in_office_tab_srs  where Entityref = 'BEA000000002180' and MatterNo = 1
...
-- MY FILE
-- Client Ledger
select * from Ac_Client_Ledger_Transactions WHERE Client_Code = 'TES000000001253' AND Matter_No = 2


-- Cheques Table
select * from Usr_Incoming_Cheque_Details  where Entityref = 'TES000000001253' and MatterNo = 2
-- Client Table
select * from usr_cheques_in_client_tab_srs  where Entityref = 'TES000000001253' and MatterNo = 2
-- Office Table
select * from usr_cheques_in_office_tab_srs  where Entityref = 'TES000000001253' and MatterNo = 2
...
/* Reset
delete from Usr_Incoming_Cheque_Details  where Entityref = 'BEA000000002180' and MatterNo = 1
delete from usr_cheques_in_client_tab_srs  where Entityref = 'BEA000000002180' and MatterNo = 1
delete from usr_cheques_in_office_tab_srs  where Entityref = 'BEA000000002180' and MatterNo = 1
*/

/* Reset MY FILE ----------------------------------------------------------------------------------------------
delete from Usr_Incoming_Cheque_Details  where Entityref = 'TES000000001253' and MatterNo = 2
delete from usr_cheques_in_client_tab_srs where Entityref = 'TES000000001253' and MatterNo = 2
delete from usr_cheques_in_office_tab_srs where Entityref = 'TES000000001253' and MatterNo = 2
--------------------------------------------------------------------------------------------------------------*/

delete from Ac_Client_Ledger_Transactions WHERE Client_Code = 'BEA000000002180' AND Matter_No = 1
...
delete from usr_cheques_in_client_tab_srs where Entityref = 'TES000000001253' and MatterNo = 2 and id = 109277
